...
| `revise` | User wants a draft rewritten for tone, traceability, or professional academic response | Existing draft plus target change request | Revised response text plus changed-risk notes |
