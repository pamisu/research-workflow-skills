...
description: >-
  Draft, audit, or revise point-by-point reviewer response letters for manuscript
  revisions for any peer-reviewed venue. Use when the user provides reviewer comments, editor decision
...
Unlike paper-writing or academic-figure, reviewer-response has no fragment axis. Its variation is identified at runtime, not by loading different content bodies:
...
- This structure mirrors `paper-writing`, `paper-polishing`, `paper-reader`, `paper2ppt`, `academic-figure`, and `targeted-citation`.
