# LaTeX layout & float typesetting for academic manuscripts
...
## 3. Do NOT rotate to landscape (common journal house style)

Many journals discourage rotated/landscape figures that force the
...
but try the redraw first. If the user defers ("do what journals do"), choose upright.
