...
- use venue-appropriate spelling (check target journal/conference guidelines)
- keep figure legends concise; `<= 300` words is a good upper bound
- keep titles at `<= 75` characters including spaces
