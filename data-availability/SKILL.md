...
description: >-
  Prepare, audit, or revise publication-ready Data Availability statements, data repository plans,
  dataset citations, and FAIR metadata checklists for manuscripts. Use when the user asks about
  research data availability, data sharing, repository selection, accession numbers,
  ...
  wording for Chinese-speaking authors preparing journal and conference submissions.
  Also trigger on general academic-writing data needs, such as
...
# Data Availability Statement — Router
...
Unlike paper-writing or academic-figure, this skill has no fragment axis. Its variation is handled at runtime, not by loading different content bodies:
...
- This structure mirrors other skills in this collection (paper-writing, paper-polishing, paper2ppt, academic-figure, targeted-citation, reviewer-response).
