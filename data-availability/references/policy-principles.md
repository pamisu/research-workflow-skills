...
Use this file when deciding what a publication-ready data statement must disclose.
...
- Multiple venues (ACM, IEEE, USENIX, Springer Nature, etc.) require or strongly recommend Data
  Availability statements for original research articles, asking authors to describe available data,
  location, and access terms.
- Broad-audience venue reporting standards typically require prompt availability of data, materials,
  code, and associated protocols, with restrictions disclosed to editors at submission.
- Repository deposition is generally favoured over supplementary file hosting, especially for
  primary data.
- Always consult your specific target venue's author guidelines for the most current policy.
