...
Use this skill to turn a manuscript's supporting data into a transparent, publication-ready data availability package: statement text, repository plan, dataset citations, and missing-information flags.

The governing policy layer is the target venue's data policy (e.g., ACM Artifact Review and Badging, IEEE Data Availability, USENIX Open Access, Springer Nature). The implementation layer is FAIR data practice and DataCite-style citation metadata.
...
2. Target journal/conference data, code, and materials policies.
