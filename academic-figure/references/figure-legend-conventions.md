# Published Figure Legend Conventions

Use this file when **writing or auditing the legend text** of a figure or table.
It complements `journal-figure-archetypes.md`, which covers visual/layout
...
… by the publisher."* Include the permission/attribution string for any
adapted panel.
...
- Keep a publication-style legend `<= 300` words.
...
- 综述图注:聚合他人系统时逐子图一句话定性,并标注"adapted with permission from refs… by the publisher"授权。
