...
Note: These archetypes were observed in 2026 Nature papers but the patterns apply broadly to high-impact scientific figures across venues.

This note captures page-level figure patterns observed from a local 2026 sample of top-tier journal
papers, plus one top-tier journal Biomedical Engineering paper used as a clinical / ML-adjacent
cross-check.
...
## Cross-cutting top-tier journal rules from the sample
...
- Do not place all top-tier journal figures on black backgrounds; that was specific to the imaging plate archetype.
