...
submission. The values below are conservative defaults for publication-quality work.

## Current official references to verify

Check the target journal or conference author guidelines for current figure specifications.
