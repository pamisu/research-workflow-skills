...
- **Publication standard**: `font.family = 'sans-serif'`, `font.sans-serif = ['Arial']`
...
When targeting the final dimensions of a two-column journal figure page, start smaller than
...
- Keep only left + bottom spines — minimalist, top-tier journal-approved.
...
### Modality-specific palette discipline from sampled 2026 journal figures
...
### journal page archetypes from sampled 2026 papers

`top-tier journal` figures were not uniformly dashboard-like. They repeatedly used a few strong page
archetypes:
...
To match publication standards:
