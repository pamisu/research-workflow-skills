...
`paper-writing` 用于根据作者提供的 claims、图表、结果、笔记或中文草稿，起草或重建学术手稿章节。
...
该技能用于论证构建和章节起草。如果已有英文草稿只需要句子级润色，应使用 `paper-polishing`。

## 来源基础

该技能来自对材料、能源系统、建筑脱碳和机器学习等领域顶级期刊与会议研究论文的细读，并结合仓库中已有的 writing-strategy 规则。
...
| 引言 | 领域尺度、瓶颈、已有尝试、未解决缺口、本文工作；面向高影响力综合期刊时使用分阶段 summary-paragraph funnel |
