# Broad-Audience Summary Paragraph Guide

## What this reference is for

This file distills the widely circulated annotated `Nature` example on how to construct a summary paragraph for a broad-audience paper. In high-impact interdisciplinary journals, this "summary paragraph" usually refers to the abstract-like opening summary that must let a non-specialist reader understand:
...
1. the target journal is a broad-audience journal,
...
A strong broad-audience summary paragraph is not just a compressed abstract. It is a tightly staged reader funnel:
...
When drafting a broad-audience summary paragraph:
...
1. Use this file together with `references/abstract.md` when the user is drafting an abstract for a broad-audience venue.
...
4. Use this file when the user specifically needs the stronger broad-audience summary paragraph logic rather than a generic abstract template.
