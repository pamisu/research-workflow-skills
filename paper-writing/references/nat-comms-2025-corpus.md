...
Note: This corpus is derived from 20 open-access Nature Communications articles in computer science / AI (2025). CS/security conference venues (IEEE S&P, CCS, NDSS, USENIX Security) may follow different structural patterns.
...
> `paper-polishing/references/published-article-patterns.md`. This file adds
