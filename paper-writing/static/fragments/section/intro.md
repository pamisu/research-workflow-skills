...
For a broad-audience summary paragraph, strengthen this into (See `references/broad-audience-abstract.md`.):
...
1. Establish the field stake. Make it land for a non-specialist if the target is broad (high-impact interdisciplinary journals).
